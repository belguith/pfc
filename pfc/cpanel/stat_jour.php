...
echo '<p class="titre_date">Voir les statistiques d\'un autre jour :<br /><br /></p>';
...
echo '<p class="titre_date"><br />Les statistiques du '.$date_d.'/'.$date_m.'/'.$date_Y.' : <br /><br /></p>';
...
echo '<p class="titre_date"><br />Les meilleurs referer :<br /><br /></p>';

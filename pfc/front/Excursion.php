    ...
    <body>
		...
		<!-- End POPUP  -->
			...
			<h2> Nos Excursions </h2>
			 ...
			 <p class="desc_at">     Au coeur de DarTak, on vous offre l'opportunité de visiter les endroits les plus magnifiques de la tunisie surtout  du cap bon. Vous aller profiter du soleil et des plages merveilleuses du Haouaria , port des princes , Kelibia et Korbous   </p>
			 </div>
			...
			$result=mysql_query("SELECT * FROM excursion ORDER BY date_debut DESC");
			while($row=mysql_fetch_array($result))
			{	
				echo	"<div class='box'>";  
				echo "<img src=".$row['imge_excursion']." alt='img box'></img>";
				echo "<div class='box_desc'>";
				echo "<h3>".$row['destination_excursion']."</h3>";
				echo "<p> ".$row['lilbelle_excursion']." </p>";
